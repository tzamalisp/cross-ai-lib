...
from processing.motion.project_processing_motion_variables import axes_acc, axes_gyro
from tsaug import AddNoise, TimeWarp, Crop, Quantize, Drift, Reverse, Dropout, Convolve, Pool, Resize
