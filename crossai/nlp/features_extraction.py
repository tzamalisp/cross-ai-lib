...
def avg_chars_per_sentence(clean_text, nltk_language="greek"):
    ...
    tokenizer = nltk.data.load(
        'tokenizers/punkt/{}.pickle'.format(nltk_language))
...
def count_consecutive_chars(clean_text, vowels="αεηιυοωaeiou", mode="tweet"):
    """
    Counts consecutive characters found in a string. These are, simple
    characters, consecutive vowels, and consecutive
    found consonants.
    Args:
