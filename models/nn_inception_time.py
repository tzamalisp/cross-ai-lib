...
class ClassifierInceptionTime:
    ...
    def __init__(self, number_of_classes=None, train_data_shape=None, nb_filters=32,
                 use_residual=True, use_bottleneck=True, depth=6, kernel_size=41,
                 drp_input=0, drp_high=0, spatial=False,
        ...
        if kernel_constraint is not None:
            self.kernel_constraint = MaxNorm(max_value=kernel_constraint, axis=[0, 1])
